        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="custom-file mb-3">
                            <input type="file" class="custom-file-input @error('ktp') is-invalid @enderror" id="ktp"
                                name="ktp" accept="image/*" onchange="previewKtp(event)">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="custom-file mb-3">
                            <input type="file" class="custom-file-input @error('kartu_keluarga') is-invalid @enderror" id="kartu_keluarga"
                                name="kartu_keluarga" accept="image/*" onchange="previewKartu_keluarga(event)">
                            <label class="custom-file-label" for="ktp">Choose file</label>
                        ...
                        <div>
                            <img id="kartukeluarga-preview" src="{{ asset('img/kartu_keluarga.jpg') }}" alt="Preview kartu Keluarga"
                                style="max-width:200px;max-height:200px;">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="custom-file mb-3">
                            <input type="file" class="custom-file-input @error('surat_nikah') is-invalid @enderror" id="surat_nikah"
                                name="surat_nikah" accept="image/*" onchange="previewSurat_nikah(event)">
                            <label class="custom-file-label" for="ktp">Choose file</label>
                            @error('surat_nikah')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
                        ...
                        <div>
                            <img id="suratnikah-preview" src="{{ asset('img/surat_nikah.jpg') }}" alt="Preview Surat Nikah"
                                style="max-width:200px;max-height:200px;">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <div class="custom-file mb-3">
                            <input type="file" class="custom-file-input @error('izin_usaha') is-invalid @enderror" id="izin_usaha"
                                name="izin_usaha" accept="image/*" onchange="previewIzin_usaha(event)">
                            <label class="custom-file-label" for="ktp">Choose file</label>
                            @error('izin_usaha')
                            <small class="text-danger">{{ $message }}</small>
                            @enderror
