...
<html>
  ...
  <body bgcolor="2e2929">
    <article>
        ...
        <div>
            <p>Mohon tuggu beberpa saat tim kami akan segera menambahkan fitur ini.  Klik <a href="{{route('admin.dashboard')}}">disini</a> untuk kembali..!</p>
            <p>&mdash; IT Bank Waway</p>
        </div>
    </article>
  </body>
</html>