        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Pelayanan Konsumen</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="row">
              ...
              <div class="table-responsive mailbox-messages" style="height: 220px;">
                <div class="card-body">
                  <table id="example1" class="table table-striped table-hover"> 
                    ...
                    <tbody> 
                      @foreach ($stsmGetDataPelayananKons as $item)
                        <tr>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content bg-light">
                                  ...
                                  <div class="modal-footer justify-content-between">
                                    ...
                                    <a href="{{route('admin.pelayananKonsumenDelete', encrypt($item->id) )}}" type="button" class="btn btn-outline-danger">Delete</a>
                                  </div>
                                </div>
                                <!-- /.modal-content -->
                              </div>
        ...
        <div class="col-md-6">
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3>Input Pelayanan Kustomer </h3>
              <!-- /.card-tools -->
            </div>
            <!-- /.card-header -->
            <div class="card-body p-0">
              <div class="table-responsive mailbox-messages" style="height: 220px;">
                <div class="card-body">
                  <form action="{{route('admin.uploadPelayananKonsumen')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}  
                    @if ($errors->any())
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-danger card-outline">
              ...
              <iframe src="https://bankwawaylampung.com/laporan-pelayanan-kons" height="520px" title="description"></iframe> 
            </div>
        </div>
