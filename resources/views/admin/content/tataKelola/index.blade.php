  ...
  <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tata Kelola / GCG</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Laporan</a></li>
              <li class="breadcrumb-item active">Tata kelola / GCG</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="table-responsive mailbox-messages" style="height: 220px;">
                <div class="card-body">
                  <table id="example1" class="table table-striped table-hover"> 
                    ...
                    <tbody> 
                      @foreach ($stmtTataKelola as $item)
                        <tr>
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content bg-light">
                                  ...
                                  <div class="modal-footer justify-content-between">
                                    ...
                                    <a href="{{route('admin.tataKelolaDelete', encrypt($item->id) )}}" type="button" class="btn btn-outline-danger">Delete</a>
                                  </div>
                                </div>
                                <!-- /.modal-content -->
                              </div>
        ...
        <div class="col-md-6">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              <div class="table-responsive mailbox-messages" style="height: 220px;">
                <div class="card-body">
                  <form action="{{route('admin.uploadTataKelola')}}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}  
                    @if ($errors->any())
                    ...
                    <div class="card-body">
                        <div class="input-group mb-3">
                            ...
                            <span class="input-group-text"><span class="text-danger font-weight-bold">&ast;</span> Judul Tata Kelola</span>
                            </div>
                            <input type="text" name="judul" value="{{ old('judul') }}" class="form-control {{ $errors->has('judul') ? ' is-invalid' : '' }}" placeholder="Contoh: Tahun 2023">
                            @if ($errors->has('judul'))
      ...
      <div class="row">
        ...
        <div class="col-md-12">
            <div class="card card-danger card-outline">
              ...
              <iframe src="https://bankwawaylampung.com/laporan-gcg" height="520px" title="description"></iframe> 
            </div>
        </div>
