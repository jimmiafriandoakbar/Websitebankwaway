            ...
            <div class="card col-8">
                ...
                <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-6">
                        <lottie-player src="https://assets10.lottiefiles.com/packages/lf20_Y76lSjmxMO.json"  background="transparent"  speed="1"  style="width: 450px; height: 350px;"  loop autoplay></lottie-player>
                      </div>
                    </div>
                </div>  
                <!-- /.card-body -->
                <div class="card-footer">
                    <div class="breadcrumb-item"><a href="#" class="text-danger">
                      <img src="{{asset('logo.png')}}" width="253px" height="60px" alt="">
                    </a></div>
                </div>
                <!-- /.card-footer-->
