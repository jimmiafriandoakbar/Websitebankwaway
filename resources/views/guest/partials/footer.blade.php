...
<div class="container-fluid bg-secondary text-white mt-1 py-3 px-sm-3 px-md-5">
    ...
    <div class="row pt-5">
        <div class="col-lg-3 col-md-6 mb-5">
            <img class="img-fluid" src="{{ asset('assetGuest/img/logo-website2.png') }}" alt="" width="250px"
                height="58px">
            ...
            <div class="d-flex justify-content-start mt-4">
                ...
                <a class="btn btn-outline-white rounded-circle text-center mr-2 px-0" style="width: 38px; height: 38px;"
                    href="https://web.facebook.com/BankWawayLampung/?_rdc=1&_rdr"><i class="fab fa-facebook-f"></i></a>

                <a class="btn btn-outline-white rounded-circle text-center mr-2 px-0" style="width: 38px; height: 38px;"
                    href="https://www.instagram.com/bankwawaylampung/" target="_blank"><i
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <form action="{{ route('kritik') }}" method="post">
                ...
                <div class="form-group">
                    <input type="text" name="nama" class="form-control border-0 py-4" placeholder="Your Name" required>
                    @error('nama')
                ...
                <!-- INPUT NOMOR HP -->
                <div class="form-group">
                    <input type="text" name="no_hp" class="form-control border-0 py-4" placeholder="Nomor HP" required
                ...
                <div class="form-group">
                    <textarea class="form-control" name="pesan" rows="3" placeholder="Kritik, saran atau pertanyaan"
                        required></textarea>
                    @error('pesan')
                    <span class="text-danger" role="alert">
                        <strong>{{ $message }}</strong>
